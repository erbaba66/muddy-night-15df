...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/muddy-night-15df)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-night-15df
```

A live public deployment of this template is available at [https://muddy-night-15df.templates.workers.dev](https://muddy-night-15df.templates.workers.dev)
